...
const Header = () => {
    ...
    return (
        <div className='' >
            <div className={` bg-[] z-50 w-full header py-3 header-container  flex flex-col md:flex-row justify-around items-center `}>
                <div className="header-logo flex justify-around around items-center w-full  md:w-1/6">

                    {/* header logo and name  */}

                    <Link to='/' className={`font-bold flex  text-lg md:text-2xl`}>
                        <h1 className='text-red-700 '>YouFliix</h1>
                    </Link>
